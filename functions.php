...
function barber_styles(){
    ...
    wp_enqueue_style("custom-goggle-fonts","//fonts.googleapis.com/css2?family=Bebas+Neue&family=Open+Sans+Condensed:wght@300&family=Teko:wght@300&display=swap");
